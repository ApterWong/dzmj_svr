...
{
    if(login_bev == NULL) {
        cout << "write_data_to_login err: login_bev is null point\n";
        return ;
    }
...
{
    if(worker_bev == NULL) {
        cout << "write_data_to_worker err: worker_bev is null point\n";
        return ;
    }
...
{
    if(gateway_bev == NULL) {
        cout << "write_data_to_gateway err: gateway_bev is null point\n";
        return ;
    }
